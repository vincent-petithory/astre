...
package astre.processor 
{
	...
	import astre.processor.process.AsyncFunctionProcess;
	import astre.processor.process.AsyncProcess;
	import astre.processor.process.MainMethodProcess;
	import astre.processor.process.SetUpProcess;
	import astre.processor.process.TearDownProcess;
	import astre.processor.process.TestProcessEvent;
 ...
 * classes, like 
 * <code class="prettyprint">astre.processor.AbstractTestProcessor</code> and 
 * <code class="prettyprint">astre.processor.TestProcessor</code>, or create a 
 * new class implementing the 
 * <code class="prettyprint">astre.processor.ITestProcessor</code> 
